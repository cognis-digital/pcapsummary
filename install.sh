#!/usr/bin/env sh
# Universal installer for pcapsummary. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/pcapsummary.git"
echo "Installing pcapsummary ..."
...
echo "Done. Run: pcapsummary --help"
