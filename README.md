...
[![PyPI](https://img.shields.io/pypi/v/cognis-pcapsummary.svg)](https://pypi.org/project/cognis-pcapsummary/)
[![CI](https://github.com/cognis-digital/pcapsummary/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/pcapsummary/actions)
...
PCAPSUMMARY exists for one job — summarize flows/talkers/protocols from a pcap text export — and does it without a SaaS bill or heavyweight setup.
...
```bash
pcapsummary --version
pcapsummary scan .                      # scan the current project
pcapsummary scan . --format json
pcapsummary scan . --fail-on high       # non-zero exit for CI gates
pcapsummary mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **tshark**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`pcapsummary` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
