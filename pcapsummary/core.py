"""PCAPSUMMARY core — Summarize flows/talkers/protocols from a pcap text export."""
...
RULES = [
    ("PCA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("PCA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("PCA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
